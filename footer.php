        ...
        <div class="container mx-auto w-full">
            <div class="mx-auto grid w-full grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-4">
                ...
                <ul class="m-0 list-none pl-3">
                    <h4 class="mb-2 font-semibold -ml-3">Help Center</h4>
                    <li><a href="#" class=" text-slate-600 hover:text-slate-800">
                        Discord</a></li>
                    <li><a href="#" class="text-slate-600 hover:text-slate-800">
                        Twitter</a></li>
                    <li><a href="#" class="text-slate-600 hover:text-slate-800">
                ...
                <ul class="m-0 list-none pl-3">
                    <ph4 class="mb-2 font-semibold -ml-3">Resources</h4>
                    <li><a href="#" class="text-slate-600 hover:text-slate-800">
                        Blog</a></li>
                    <li><a href="#" class="text-slate-600 hover:text-slate-800">
                        Newsletter</a></li>
                ...
                <ul class="m-0 list-none pl-3">
                    <h4 class="mb-2 font-semibold -ml-3">Products</h4>
                    <li><a href="#" class="text-slate-600 hover:text-slate-800">
                        Templates</a></li>
                    <li><a href="#" class="text-slate-600 hover:text-slate-800">
                        UI Kits</a></li>
            ...
            <div class="mt-10 flex w-full flex-col items-center justify-center gap-4 border-t border-slate-200 py-4 md:flex-row md:justify-between">
                <div class="font-sans antialiased text-sm text-slate-600 text-left">
                    ...
                    <a href="<?php echo esc_url( __( '', 'globalizer' ) ); ?>">
                        <?php
                        printf( esc_html__( 'Proudly powered by %s', 'globalizer' ), 'WordPress' );
                        ?>
                    </a>
                </div>
